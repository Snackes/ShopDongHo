                                ...
                                <div id="formDangNhap" class="modal">
                                	<form id="FormDN" class="modal-content animate" action="">
                                		...
                                		<div class="container input-formDangNhap">
                                			...
                                			<input id="uname" class="input-text" type="text" placeholder="Nhập Tên Tài Khoản" name="uname" required>
                                			<label for="psw" style="color:#fff;"><b>Mật Khẩu</b></label>
                                			<input id="pws" class="input-text" type="password" placeholder="Nhập Mật Khẩu" name="pws" required>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7">
                            <div class="div_ThongTinThanhToan">
                                <div class="form_DatHang">
                                    ...
                                    <input id="uname" type="text" name="uname" placeholder="Họ và Tên" class="form-control" maxlength="256"
                                        data-bv-field="uname" required>
                                    ...
                                    <input type="text" name="address" placeholder="Địa chỉ" class="form-control" maxlength="256"
                                        data-bv-field="address" required>
                                    ...
                                    <input type="text" name="Address_city" placeholder="Tỉnh / Thành phố" class="form-control"
                                        maxlength="256" data-bv-field="Address_city" required>
                                    <i class="form-control-feedback" data-bv-icon-for="Address_city" style="display: none;"></i>
                
                                    <label for="mobile"><b>Số điện thoại</b></label>
                                    <input type="number" name="mobile" placeholder="Số điện thoại" class="form-control" maxlength="256"
                                        data-bv-field="mobile" required number="number">
