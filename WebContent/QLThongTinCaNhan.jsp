...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <form class="form-horizontal bv-form" name="frmProfiles_edit" id="frmProfiles_edit" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row form-group required has-feedback">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="fullname" placeholder="Họ tên của bạn" class="form-control"
                                            maxlength="256" data-bv-field="fullname">
                                ...
                                <div class="row form-group required has-feedback">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="email" placeholder="Email" class="form-control"
                                            maxlength="256" data-bv-field="email"><i class="form-control-feedback"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row form-group required has-feedback">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="mobile" placeholder="Điện thoại" class="form-control"
                                            maxlength="256" data-bv-field="mobile"><i class="form-control-feedback"
                                ...
                                <div class="row form-group has-feedback">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="address" placeholder="Địa chỉ" class="form-control"
                                            maxlength="256" data-bv-field="address"><i class="form-control-feedback"
                ...
                <div class="col-md-9" id="DivTongDoiMatKhau">
                    ...
                    <div class="ThongTinDoiMatKhau">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row form-group required has-feedback">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="OldPass" placeholder="Mật khẩu cũ" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row form-group required has-feedback">
                                    <label class="control-label col-sm-3" for="PassMoi">Mật khẩu mới</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="PassMoi" placeholder="Mật khẩu mới" class="form-control"
                                            maxlength="256" data-bv-field="PassMoi"><i class="form-control-feedback"
                                            data-bv-icon-for="PassMoi" style="display: none;"></i>
                                        <small data-bv-validator="stringLength" data-bv-validator-for="PassMoi" class="help-block"
                                            style="display: none;">This value is not valid</small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row form-group required has-feedback">
                                    <label class="control-label col-sm-3" for="NhapLai">Nhập lại</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="NhapLai" placeholder="Nhập lại mật khẩu mới" class="form-control"
                                            maxlength="256" data-bv-field="NhapLai"><i class="form-control-feedback"
                                            data-bv-icon-for="NhapLai" style="display: none;"></i>
                                        <small data-bv-validator="stringLength" data-bv-validator-for="NhapLai" class="help-block"
                                            style="display: none;">This value is not valid</small>
                                    </div>
                                </div>
                            </div>
